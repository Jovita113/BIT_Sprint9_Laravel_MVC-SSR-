    ...
    <div class="relative bg-white overflow-hidden">
                                    ...
                                    @else
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item bg-blue-500" href="{{ route('logout') }}"
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">Cosmo Boy Chupi!</span>
                            <span class="block text-indigo-600 xl:inline">Toys for Kids</span>
                        </h1>
                        <p
                            class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            As technology evolves ever more quickly in all aspects of modern living, it is important
                            that the next generation know as much as possible about design, electronics, programming and
                            integration in order to stay competitive. This is why robotics is becoming increasingly
                            important at all levels of education.</p>
                    </div>
                </main>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
                src="https://cdn.dribbble.com/users/4835348/screenshots/17436871/media/bcd419297ff23e27b4ff3393fd5f1393.png"
                alt="">
        </div>
    </div>
